...
urlpatterns = [
    ...
    path('dashboard_clima/monthplus',views.update_month_plus,name="update_month_plus"),
    path('dashboard_clima/monthminus',views.update_month_minus,name="update_month_minus"),
